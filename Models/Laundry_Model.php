...
<!-- In this file we handle with SQL queries the database logic about the laundry machines. -->
    ...
    class Laundry_Model {
        ...
        public function getUsageHistoryByUser($userId) {
            ...
            $result = $this->connection->query(
                "SELECT usersTable.*, machinesTable.name as machine_name, machinesTable.type as machine_type
                FROM reseasy_laundry_usage usersTable
                JOIN reseasy_machines machinesTable ON usersTable.machine_id = machinesTable.machine_id
                WHERE usersTable.user_id=$userId ORDER BY usersTable.start_time DESC LIMIT 10
            ");
