...
<!-- In this file we handle with SQL queries the database logic about the Contact Logs table, which records calls between staff members and residents. -->
...
<?php
    class ContactLogs_Model {
        ...
        public function getByCaller($staffId) {
        ...
        public function getByCalled($residentId) {
