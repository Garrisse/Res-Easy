...
<!-- In this file we handle with SQL queries the database logic about the Dispatch table, the one that assigns some staff to a residence in a relationship 1:N. -->
...
<?php
    class Dispatch_Model {
        ...
        public function getByResidence($residenceCode) {
            ...
            $result = $this->connection->query(
                "SELECT dispatchTable.*, staffTable.name as staff_name, staffTable.surname as staff_surname, staffTable.staff_type, staffTable.phone, staffTable.emerg_callable, usersTable.email
                 ...
                 WHERE d.residence_id='$residenceCode'
