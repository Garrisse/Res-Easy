...
<!-- In this file we handle with SQL queries the database logic about the bookings Table, the middle table between spaces and residents (a resident books a space). -->
...
$this->connection->query("
                    CREATE TABLE reseasy_bookings (
                        ...
                        FOREIGN KEY (space_id) REFERENCES reseasy_spaces(space_id) ON DELETE CASCADE
                    );
                ");
            }
        }
